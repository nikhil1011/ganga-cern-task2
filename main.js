...
define([
	...
	for(var i = 0; i<ncells; i++){
		...
		if((currentCell instanceof textcell.TextCell) && (currentCell.rendered)){
			currentCell.element[0].innerHTML = currentCell.element[0].innerHTML.replace(/SWAN/g,"<img src='/nbextensions/Task2/logo_swan_cloudhisto.png' style='width:25px;height:25px;display:inline'/>");
		}
	}
